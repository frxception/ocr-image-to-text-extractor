    ...
    <div className={`relative bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden ${className}`}>
      ...
      <div className="absolute top-2 right-2 z-10 flex flex-col space-y-1">
        <button
          ...
          disabled={isCropMode}
        >
          <ZoomIn className={`w-4 h-4 ${isCropMode ? 'text-gray-400' : 'text-gray-600 dark:text-gray-400'}`} />
        </button>
        <button
          ...
          disabled={isCropMode}
        >
          <ZoomOut className={`w-4 h-4 ${isCropMode ? 'text-gray-400' : 'text-gray-600 dark:text-gray-400'}`} />
        </button>
        {onCrop && (
          <button
      ...
      >
        <img
          ...
          style={{
            ...
            cursor: isCropMode ? 'crosshair' : scale > 1 ? (isDragging ? 'grabbing' : 'grab') : 'default'
          }}
          draggable={false}
        />
        ...
        {isCropMode && cropStart && cropEnd && (
          <>
            ...
            >
              {/* Vertical lines */}
              <div className="absolute w-px bg-white/50" style={{ left: '33.33%', top: 0, bottom: 0 }} />
              <div className="absolute w-px bg-white/50" style={{ left: '66.66%', top: 0, bottom: 0 }} />
              {/* Horizontal lines */}
              <div className="absolute h-px bg-white/50" style={{ top: '33.33%', left: 0, right: 0 }} />
              <div className="absolute h-px bg-white/50" style={{ top: '66.66%', left: 0, right: 0 }} />
            </div>
